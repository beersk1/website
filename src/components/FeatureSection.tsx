    ...
    <section id="features" className="section relative">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="glass-card rounded-xl p-6 shadow-lg">
              <div className="h-16 w-16 rounded-full bg-brand-blue/10 flex items-center justify-center mb-6">
                {feature.icon}
              </div>
        ...
        <div className="relative mt-24 overflow-hidden rounded-2xl">
          <div className="absolute inset-0 bg-gradient-to-r from-brand-blue to-brand-darkBlue opacity-90"></div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 p-8 md:p-12">
            ...
            <a 
              href="#contact" 
              className="whitespace-nowrap px-6 py-3 bg-white text-brand-blue rounded-md font-medium hover:bg-opacity-90 transition-all shadow-lg"
            >
              Schedule Now
            </a>
          </div>
