...
const facts = [
  {
    ...
    description: "A helmet can hold 20,000+ bacteria per square inch—more than a toilet seat."
  },
  {
    icon: <Droplet className="h-6 w-6 text-brand-red" />,
    title: "Sweat & Oil Trap",
    description: "Sweat, oil, and dust get trapped in the padding, creating an ideal environment for bacteria."
  },
  {
    icon: <AlertTriangle className="h-6 w-6 text-brand-red" />,
    title: "Ineffective Cleaning",
    description: "Traditional washing methods don't eliminate bacteria from the inner lining."
  },
  {
    icon: <BookOpen className="h-6 w-6 text-brand-red" />,
    title: "Health Risks",
    description: "Dirty helmets can cause skin irritations, acne, and other health issues."
  }
];
